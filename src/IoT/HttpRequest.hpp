...
#include "RequestModelDto.hpp"

#include "oatpp/web/client/ApiClient.hpp"
#include "oatpp/core/macro/codegen.hpp"

class HttpRequest : public oatpp::web::client::ApiClient {
#include OATPP_CODEGEN_BEGIN(ApiClient)
  
  API_CLIENT_INIT(HttpRequest)
  ...
  API_CALL("POST", "post", doPostWithDto, BODY_DTO(RequestDto::ObjectWrapper, body))
  ...
  API_CALL_ASYNC("DELETE", "delete", doDeleteAsync)
   ...
   API_CALL_ASYNC("POST", "post", doPostWithDtoAsync, BODY_DTO(RequestDto::ObjectWrapper, body))
